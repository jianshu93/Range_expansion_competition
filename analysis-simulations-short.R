...
## Save output
write.table(x = N.stor, file = "simulations/dataN-simulate-wetnocomp.csv", sep = ",", row.names = FALSE, col.names = FALSE)
...
## Save output
write.table(x = N.stor, file = "simulations/dataN-simulate-wetcomp.csv", sep = ",", row.names = FALSE, col.names = FALSE)
write.table(x = M.stor, file = "simulations/dataM-simulate-wetcomp.csv", sep = ",", row.names = FALSE, col.names = FALSE)
