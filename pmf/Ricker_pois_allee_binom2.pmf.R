Ricker_pois_allee_binom2.pmf <- function(Xt, Xtp1, Yt, Rx, alphaxx, alphaxy, thetax, ...){
    ...
    if(isTRUE(any(is.na(c(Xt, Xtp1, Yt)))) || Xt == 0 & Xtp1 == 0){
        ...
        if(Xt == 0 & Xtp1 > 0 | Xt < 2 & Xtp1 > 0){
            ...
            if(Xtp1 > 0){
                ...
                sum(exp(dbinom(f_X, Xt, z, log = TRUE) + dpois(Xtp1, f_X * Rx * (Xt / (thetax + Xt)) * exp(-(alphaxx * Xt + alphaxy * Yt)), log = TRUE)))
            } else{
